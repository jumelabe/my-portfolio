        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-8 order-2 lg:order-1">
            <div className="bg-slate-50 p-8 rounded-2xl border border-gray-100 flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="font-bold text-neutral-dark text-lg mb-1">
                  Email
                </h3>
                ...
                <a
                  href="mailto:labejumel@gmail.com"
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border border-gray-100 flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="https://github.com/jumelabe"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/jumelabe"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary font-semibold hover:underline"
                  >
